...
export function studyComponentToIndividualComponent(
  stepConfig: InheritedComponent | IndividualComponent,
...
export function getComponent(
  ...
  return studyComponentToIndividualComponent(
    studyConfig.components[name],
    studyConfig,
  );
}
