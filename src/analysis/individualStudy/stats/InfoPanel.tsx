...
export function InfoPanel(props: {
  ...
  useEffect(() => {
    ...
    function calculateStats() {
      ...
      const mid =
        durationAry.length % 2 === 0
          ? (durationAry[durationAry.length / 2] +
              durationAry[durationAry.length / 2 - 1]) /
            2
      ...
      >
        ...
        {(config?.description || config?.instruction) && (
          <Card
            ...
            p={5}
            style={{
              boxShadow: "1px 2px 2px 3px lightgrey;",
              borderRadius: "5px",
            }}
          >
            <Box
        ...
        {trialName.length > 0 && (
          ...
          >
            ...
            <Group>
              <Box mih={105} p={5}>
                <Box>
                  <Badge radius="xs" style={{ display: "inline" }}>
                    Fastest:
                  </Badge>
