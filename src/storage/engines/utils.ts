...
export function isParticipantData(obj: unknown): obj is ParticipantData {
  ...
  return (
    typeof potentialParticipantData === "object" &&
    potentialParticipantData &&
    potentialParticipantData.participantId !== undefined
  );
}

export function isCloudStorageEngine(
  engine: StorageEngine | undefined,
): engine is CloudStorageEngine {
