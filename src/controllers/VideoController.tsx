...
const CustomPlyrInstance = forwardRef<
  APITypes,
  PlyrProps & { endedCallback: () => void; errorCallback: () => void }
>((props, ref) => {
  const { source, options = null, endedCallback, errorCallback } = props;
