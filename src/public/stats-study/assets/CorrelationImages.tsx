  ...
  return (
    <div style={{ width: "100%", padding: 16 }}>
      ...
      <Text size="md" ta="left" maw={650} style={{ marginLeft: 200, marginBottom: 10 }}>
        ...
        a range of correlations. <br />
        Take your time to observe how the points are arranged, and notice how the strength and direction
        of the relationship changes across the graphs.<br />
        Please study the scatterplots and their different correlation values for <strong>at least 1 minute</strong>. <br />
