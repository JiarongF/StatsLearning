...
export default function CorrelationFixedPostPlay({
  parameters,
  setAnswer,
  provenanceState,
  ...
  return (
    <Card padding="md" radius="md">
      <Stack gap="sm">
        ...
        <Text size="lg">Please draw 5 datapoints that you think would INCREASE the correlation of this scatterplot.  When you are ready to submit, click the Next button
</Text>
